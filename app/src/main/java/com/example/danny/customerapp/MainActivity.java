...
public class MainActivity extends AppCompatActivity      {
    ...
    public void forgot(View arg0) {

        Toast.makeText(MainActivity.this, "Please find our staff", Toast.LENGTH_LONG).show();
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://192.168.25.124/test/login.inc.php");
    ...
    public void Logout(View view) {
        Toast.makeText(MainActivity.this, "Please connect our company hotline — 5344 4423", Toast.LENGTH_LONG).show();
    }
}
